...
echo "🗄️  Setting up MySQL database and user for macOS..."
echo "=================================================="
...
# Check if MySQL is running (macOS specific)
...
# Function to execute MySQL command as root
mysql_exec() {
    mysql -u root -e "$1"
}
...
mysql_exec "DROP USER IF EXISTS '$DB_USER'@'localhost';" 2>/dev/null || true
